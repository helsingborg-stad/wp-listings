<form method="post" action="" class="creamy gutter gutter-lg">
    ...
    <div class="grid gutter gutter-bottom">
        <div class="grid-md-12">
            <div class="notice success">
                <?php _e('Your message has been delivered to the seller.', 'wp-listings'); ?>
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <h2><?php _e('Contact the seller', 'wp-listings'); ?></h2>

    <?php if (get_field('listing_display_seller_phone_number')) : ?>
    <strong><?php _e('Phone number', 'wp-listings'); ?>:</strong> <?php echo get_post_meta(get_the_id(), 'listing_seller_phone_number', true); ?>
    <?php endif; ?>

    <h3 class="gutter gutter-lg gutter-vertical"><?php _e('Send email', 'wp-listings'); ?></h3>
    <div class="grid">
        <div class="grid-md-6">
            <div class="form-group">
                <label for="contact-name"><?php _e('Your name', 'wp-listings'); ?><span class="text-danger">*</span></label>
                <input type="text" name="name" id="contact-name" required>
            </div>
        </div>
        <div class="grid-md-6">
            <div class="form-group">
                <label for="contact-email"><?php _e('Your email', 'wp-listings'); ?><span class="text-danger">*</span></label>
    ...
    <div class="grid">
        <div class="grid-md-12">
            <div class="form-group">
                <label for="contact-message"><?php _e('Message', 'wp-listings'); ?><span class="text-danger">*</span></label>
